...
finalwork() {
	[ ! -e ${DESTINATION}/finaltouchup1.sh ] && curl --silent -LO https://ghproxy.com/https://github.com/jiankujidu/TermuxAlpine/raw/main/finaltouchup1.sh
	if [ "${MOTD}" = "ON" ]; then
		bash ${DESTINATION}/finaltouchup1.sh --add-motd
	else
		bash ${DESTINATION}/finaltouchup1.sh
	fi
	rm ${DESTINATION}/finaltouchup1.sh
}
...
printline
printline
printf "\n${blue} [*] Email   :${yellow}    jiankujidu@gmail.com\n"
printf "$blue [*] 公众号 :${yellow}    一起瞎折腾\n"
printf "$blue [*] Q群 :${yellow}    113815925\n"
printline

...
addprofile()
{
	cat > ${PREFIX}/share/TermuxAlpine1/etc/profile <<- EOM
...
addmotd() {
	cat > ${PREFIX}/share/TermuxAlpine1/etc/profile.d/motd.sh  <<- EOM
...
updrepos() {
	cp ${PREFIX}/share/TermuxAlpine1/etc/apk/repositories ${PREFIX}/share/TermuxAlpine1/etc/apk/repositories.bak
	cat > ${PREFIX}/share/TermuxAlpine1/etc/apk/repositories <<- EOM
...
addresolvconf ()
{
	printf "nameserver 8.8.8.8\nnameserver 8.8.4.4" > ${PREFIX}/share/TermuxAlpine1/etc/resolv.conf
}
